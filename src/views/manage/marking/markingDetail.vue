<template>
  <div class="marking-deatil-wapper">
    <el-table v-loading="markingLoading" :data="marking" row-class-name="pointer" style="width: 100%" row-key="username" :expand-row-keys="expandRowKeys" @row-click="rowClick">
