<template>
  <div class="standerd-wrapper">
      ...
      <el-col v-for="standerd in standerdList" :key="standerd._id" :span="6">
        <el-card class="standerd-card">
          <div slot="header" class="">
            ...
            <el-button class="opbutton" type="text" icon="el-icon-edit" title="编辑" />
          </div>
          <div>
            <ul>
    ...
    <el-dialog title="添加标准" :visible="addDialogVisible" width="400px" class="add-dialog" center :show-close="false">
      ...
      <el-form label-width="80px" :model="standerdForm">
        ...
        <el-form-item label="标准/权重">
          <div class="add-standerd-box">
            <el-row v-for="s in standerdForm.standerd" :key="s.name" class="add-standerd-row" :gutter="5">
              <el-col :span="11">
